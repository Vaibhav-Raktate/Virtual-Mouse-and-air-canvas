    ...
    if _:
        ...
        if len(lm_list) != 0:
            ...
            if fingers[1] and not fingers[2]:
                cv2.circle(frame, (x1, y1), 6, (0, 0, 255))
                ...
                if fingers[1] and fingers[3]:
                    for time2 in range(1):
                        cv2.circle(img_canvas,(x1,y1), 20,(0, 0, 255))
                        continue
                        pass
                    ...
                    #elif fingers[1] and not finger[2] and fingers[3]:
                     #   break

                    #cv2.rectangle(img_canvas,(xp, yp), (x1+10, y1+10),draw_color,cv2.FILLED)
                    #cv2.line(img_canvas, (xp, yp), (x1, y1), draw_color, 20)
                   
                    #cv2.line(img_canvas, (xp, yp),(x1, y1), draw_color, 20)
                #   { cv2.line(frame, (xp+1, yp+1), (x1+1, y1+1), draw_color, 20)
                 #   cv2.line(img_canvas, (xp+1, yp+1), (x1+1, y1+1), draw_color, 20)
                  #  cv2.line(img_canvas, (xp+2, yp+2), (x1+3, y1+3), draw_color, 20)
                   # cv2.line(frame, (xp+3, yp+3), (x1+4, y1+4), draw_color, 20)
                    #cv2.line(img_canvas, (xp+3, yp+3), (x1+4, y1+4), draw_color, 20)}
