...
def button4_click():
    os.startfile("C:/project/DEPEX.pdf")

# Create label with italic bold font
label = tk.Label(window, text="WELCOME TO AIRINK", font=("Helvetica", 24, "italic bold"), fg=NEON_RED, bg=BLACK)
label.pack(pady=20)
...
button4 = ttk.Button(window, text="Open PDF", command=button4_click, style="Neon.TButton")
